...
import { IconLogout, IconPhone, IconMapPin, IconPaw } from "@tabler/icons-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl p-5" style={{ background: "#141414", border: "1px solid rgba(255,255,255,0.06)" }}>
        <h3 className="font-bold text-white mb-4 flex items-center gap-2"><IconPaw size={16} className="text-red-400" /> Mis mascotas</h3>
        {MASCOTAS.map(m => (
      ...
      <div className="rounded-xl p-5 space-y-3" style={{ background: "#141414", border: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div className="flex items-center gap-2 text-sm text-[#A3A3A3]"><IconPhone size={14} className="text-red-400" />{CLINICA_INFO.telefono}</div>
        <div className="flex items-center gap-2 text-sm text-[#A3A3A3]"><IconMapPin size={14} className="text-red-400" />{CLINICA_INFO.ubicacion}</div>
      </div>
